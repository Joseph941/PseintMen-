...
Algoritmo Proyecto
	...
	menuPrincipal[1] = "  1)Estructuras Selecitivas"
	menuPrincipal[2] = "  2)Estucturas Condicionales"
	menuPrincipal[3] = "  3)Estructuras Iterativas"
	menuPrincipal[4] = "  4)Salir"
	
	menuSelectivas[1] = "  1)Convierta a expresión matemática"
	...
	menuCondicionales[1] = "  1).Usando estas premisas crea un algoritmo que lea una fecha como un en tres variables: aaaa,mes, dia, y luego indique si el año de la fecha es un año bisiesto o no."
	...
	menuIterativas[1]= "1)Dado un número entero N, calcular e informar al usuario cuántos dígitos tiene dicho número." 
